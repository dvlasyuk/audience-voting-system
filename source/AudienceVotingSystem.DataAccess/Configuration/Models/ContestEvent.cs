...
public sealed class ContestEvent
{
    ...
    /// <summary>
    /// Идентификаторы отрядов, имеющих прямое отношение к мероприятию.
    /// </summary>
    ...
    /// Каждое значение должно быть уникальным в рамках мероприятия. Каждое значение должно являться
    /// идентификатором одного из сконфигурированных отрядов. Список может быть пустым, если
    /// мероприятие могут оценивать участники, имеющие отношение к тому же отряду.</remarks>
    ...
    /// идентификатором одного из сконфигурированных участников. Список может быть пустым, если
    /// мероприятие могут оценивать любые участники без регистрации и посещаемость мероприятия не
